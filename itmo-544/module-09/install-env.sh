...
#sudo -u ubuntu npm install  @aws-sdk/client-s3 @aws-sdk/client-rds @aws-sdk/client-secrets-manager @aws-sdk/client-sns express multer multer-s3 uuid ip mysql2

sudo -u ubuntu npm install  @aws-sdk/client-s3 @aws-sdk/client-rds @aws-sdk/client-secrets-manager express multer multer-s3 uuid ip mysql2
